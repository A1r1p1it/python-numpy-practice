...
avg_40 = student_avg[student_avg < 40]
print("Students whose average is below 40: \n", avg_40, "\n")

adding_5 = avg_40 + 5
print("Adding 5 marks to all subjects of students whose overall average is below 40: \n", adding_5, "\n")
